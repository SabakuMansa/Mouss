...
import { CalendarClock, Users, ImageIcon, Handshake, Settings, ShoppingBag } from "lucide-react";
...
const sections = [
  ...
  { href: "/admin/boutique", label: "Boutique", icon: ShoppingBag, description: "Articles et photos de la boutique" },
