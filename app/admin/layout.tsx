      ...
      <header className="flex items-center justify-between border-b border-navy-950/10 bg-navy-950 px-6 py-4">
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden gap-4 text-sm text-white/70 sm:flex">
            ...
            <Link href="/admin/partenaires" className="hover:text-white">
              Partenaires
            </Link>
            <Link href="/admin/boutique" className="hover:text-white">
              Boutique
            </Link>
            <Link href="/admin/infos" className="hover:text-white">
              Infos pratiques
            </Link>
          </nav>
        </div>
